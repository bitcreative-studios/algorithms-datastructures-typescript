...
class AnimalShelter {
  ...
  dequeueAny() {
    ...
    if (!lastDog && !lastCat) {
      ...
      return lastCat._timestamp < lastDog._timestamp
        ? this.catQueue.shift()
        : this.dogQueue.shift()
    }
  }
...
console.assert(
  animalShelter.dequeueAny()._name === "Jack",
  "Wrong Implementation"
)
console.assert(
  animalShelter.dequeueCat()._name === "Mila",
  "Wrong Implementation"
)
console.assert(
  animalShelter.dequeueDog()._name === "Rex",
  "Wrong Implementation"
)
console.assert(
  animalShelter.dequeueAny()._name === "Maniki",
  "Wrong Implementation"
)
console.assert(
  animalShelter.dequeueAny()._name === "Ralf",
  "Wrong Implementation"
)
console.assert(
  animalShelter.dequeueAny()._name === "Katia",
  "Wrong Implementation"
)
