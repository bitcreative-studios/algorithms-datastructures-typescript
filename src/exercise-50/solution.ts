...
console.assert(
  verifySequenceOfBST([5, 7, 6, 9, 11, 10, 8]) === true,
  "Wrong implementation"
)
console.assert(
  verifySequenceOfBST([7, 4, 6, 5]) === false,
  "Wrong implementation"
)
console.assert(
  verifySequenceOfBST([5, 4, 6, 7]) === true,
  "Wrong implementation"
)
console.assert(
  verifySequenceOfBST([3, 2, -1, 1]) === false,
  "Wrong implementation"
)
console.assert(
  verifySequenceOfBST([6, 3, 5, 4]) === false,
  "Wrong implementation"
)
